...
> - _Yukihiro "Matz" Matsumoto, enquanto hackeava a Matrix_
...
Prepare seu ambiente de desenvolvimento no [Primeiros Passos](first-steps.md). E não, "mkdir pasta_secreta" não conta como preparação de ambiente.

<seealso>
    <category ref="external">
        <a href="https://www.ruby-lang.org">Quartel General do Ruby</a>
        <a href="https://ruby-doc.org">Documentação para Netrunners</a>
    </category>
</seealso>
...
> - _Algum programador Ruby às 3 da manhã_